function imging_plane = whh_imging_plane( handles )
...
imging_plane.Q = img_tl;
imging_plane.C = img_tr - img_tl;      %horizontal vector
imging_plane.D = img_bl - img_tl;   %vertical vector
